...
void LinkedList<T>::insertOrdered(const T& newData) {
  ...
  LinkedList<T>::Node* h = LinkedList<T>::getHeadPtr();
  LinkedList<T>::Node* t = LinkedList<T>::getTailPtr();
...
LinkedList<T> LinkedList<T>::merge(const LinkedList<T>& other) const {
  ...
  // the function.
  LinkedList<T> merged;
  LinkedList<T>::Node* temp1 = left.getHeadPtr();
  LinkedList<T>::Node* temp2 = right.getHeadPtr();
